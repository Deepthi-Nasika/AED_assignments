...
public class StudentCatalogPanel extends javax.swing.JPanel {
     ...
     */
    public StudentCatalogPanel(JPanel userProcessContainer, ProfessorList professorList, ProfessorLoginList professorLoginList, CourseList courseList,StudentList studentList, StudentLoginList studentLoginList,HashMap<String, List<Course>> studentCour, DegreeList degreeList) {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblStudentCatalog.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        ...
        btnAddStud.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(32, 32, 32)
                .addComponent(btnAddStud, javax.swing.GroupLayout.PREFERRED_SIZE, 109, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(187, 187, 187)
    ...
    private void btnAddStudActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddStudActionPerformed
        // TODO add your handling code here:
         ...
         if(studentID.isEmpty() || studentName.isEmpty() || studentEmail.isEmpty() || studentUsername.isEmpty() || studentPassword.isEmpty()){
            JOptionPane.showMessageDialog(this, "Enter valid student details", "Warning", JOptionPane.WARNING_MESSAGE);
            return;
         }
    ...
    private void btnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewActionPerformed
        ...
        txtStudentEmail.setText(selectedStudent.getStudentEmail());
        txtStudentUserName.setText(selectedStudentLogin.getStudentUsername());
        txtStudentPassword.setText(selectedStudentLogin.getStudentPassword());
