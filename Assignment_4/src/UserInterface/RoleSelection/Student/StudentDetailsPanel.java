...
import UserInterface.RoleSelection.Admin.ReportPanel;
...
public class StudentDetailsPanel extends javax.swing.JPanel {
    ...
    public StudentDetailsPanel(JPanel userProcessContainer,ProfessorList professorList, ProfessorLoginList professorLoginList, CourseList courseList,  StudentList studentList, StudentLoginList studentLoginList, HashMap<String, List<Course>> studentCour, DegreeList degreeList) {
        initComponents();
...
//        prePopulateCoursesForStudents();
    ...
    ProfessorDetailsPanel profPanel = new ProfessorDetailsPanel(userProcessContainer, professorList, professorLoginList, courseList, studentList, studentLoginList, studentCour, degreeList);
...
//        FeedbackPanel feedback = new FeedbackPanel(userProcessContainer, professorList, professorLoginList, courseList, studentList, studentLoginList,studentCour, degreeList);
...
//    private void populateRegisteredCourseTable(String name){
//        DefaultTableModel regCoursestbl = (DefaultTableModel) tblCoursesTaken.getModel();
//        regCoursestbl.setRowCount(0);
//        
//        for(int i=0; i<studentCour.size(); i++){
//            if(studentCour.containsKey(name)){
...
//    private void prePopulateCoursesForStudents() {
//    // Assuming each student should be assigned two specific courses
//    Course course1 = courseList.getCourseList().get(1); // Method to find a course by its ID
//    Course course2 = courseList.getCourseList().get(2); // Adjust the course IDs as needed
//
//    // Iterate through all students and assign the courses
//    for (Student student : studentList.getStudentList()) {
//        List<Course> assignedCourses = new ArrayList<>();
//        assignedCourses.add(course1);
//        assignedCourses.add(course2);
//
//        // Assuming you have a way to set the courses for a student or to add them to the mapping
//        // This could be a direct setter method or adding to a HashMap as shown before
//        studentCour.put(student.getStudentID(), assignedCourses);
//    }
//}
