...
public class ThirdPartyLoginPanel extends javax.swing.JPanel {
    ...
    public ThirdPartyLoginPanel(JPanel userProcessContainer, ProfessorList professorList, ProfessorLoginList professorLoginList, CourseList courseList, StudentList studentList, StudentLoginList studentLoginList,  HashMap<String, List<Course>> studentCour, DegreeList degreeList) {
        initComponents();
    ...
    private void btnLoginDegreeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginDegreeActionPerformed
        ...
        if (Username.equals("auth") && Password.equals("auth")) {
            ThirdPartyApprovalPanel approval = new ThirdPartyApprovalPanel(userProcessContainer, professorList, professorLoginList, courseList, studentList, studentLoginList,studentCour, degreeList);
