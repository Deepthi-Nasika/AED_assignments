...
public class ProfessorDetailsPanel extends javax.swing.JPanel {
   ...
   DegreeList degreeList; 
    ...
    public ProfessorDetailsPanel(JPanel userProcessContainer, ProfessorList professorList, ProfessorLoginList professorLoginList, CourseList courseList,  StudentList studentList, StudentLoginList studentLoginList, HashMap<String, List<Course>> studentCour, DegreeList degreeList ) {
        initComponents();
    ...
    private void btnStudentListActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnStudentListActionPerformed
        ...
        ProfessorStudentListPanel studentPanel = new ProfessorStudentListPanel(userProcessContainer,professorList, professorLoginList,courseList,studentList,studentLoginList,studentCour);
    ...
    public void detailsPopulate(){
        ...
        for (int i = 0; i < courseList.getCourseList().size(); i++){
            ...
            if(c.getProfCName().equals(txtProfName.getText())){
            Object[] row = new Object[6];
            row[0] = c; 
