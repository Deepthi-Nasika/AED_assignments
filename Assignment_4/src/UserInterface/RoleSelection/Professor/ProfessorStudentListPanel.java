...
public class ProfessorStudentListPanel extends javax.swing.JPanel {
    ...
    public ProfessorStudentListPanel(JPanel userProcessContainer, ProfessorList professorList, ProfessorLoginList professorLoginList, CourseList courseList,  StudentList studentList, StudentLoginList studentLoginList,  HashMap<String, List<Course>> studentCour ) {
        initComponents();
